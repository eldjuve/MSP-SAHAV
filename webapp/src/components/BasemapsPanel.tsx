...
export function BasemapsPanel() {
  return (
    <div class="absolute top-4 right-[100px] bg-white rounded-xl shadow-md w-80 overflow-hidden">
      ...
      <div class="flex flex-col gap-2.5 px-4 pb-4">
        {BASEMAPS.map(({ type, img, label }) => (
          <button
            ...
            onClick={() => { changeBasemap(type); closePanel(); }}
          >
            <img src={img} alt={label} class="w-[100px] rounded" />
